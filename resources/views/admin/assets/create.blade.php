...
@section('breadcrumb', 'Home / Assets / Add')

@section('content')
<div class="page-header">
    <div>
        <h1><i class="fa-solid fa-plus-circle me-2" style="color:#10b981;font-size:1.1rem;"></i>Add New Asset</h1>
        <p>Register a new physical hardware asset in the company inventory system.</p>
    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input id="asset_id" type="text" class="form-control {{ $errors->has('asset_id') ? 'is-invalid' : '' }}"
                                   name="asset_id" value="{{ old('asset_id') }}" required autofocus placeholder="e.g. AST-001">
                        ...
                        <div class="col-md-6">
                            ...
                            <select id="type" class="form-select {{ $errors->has('type') ? 'is-invalid' : '' }}" name="type" required>
                                <option value="" disabled selected>Select hardware type…</option>
                        ...
                        <div class="col-12">
                            ...
                            <input id="name" type="text" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}"
                                   name="name" value="{{ old('name') }}" required placeholder="e.g. MacBook Pro M2 14-inch">
                        ...
                        <div class="col-12">
                            ...
                            <input id="serial_number" type="text" class="form-control {{ $errors->has('serial_number') ? 'is-invalid' : '' }}"
                                   name="serial_number" value="{{ old('serial_number') }}" required placeholder="e.g. C02F68K8Q05D">
